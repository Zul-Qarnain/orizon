...
const javascript_lp_solver_1 = __importDefault(require("javascript-lp-solver"));
function optimizeSchedule(hours, battery, directives) {
    ...
    // 3. Solve LP
    const solveFn = javascript_lp_solver_1.default.solve || javascript_lp_solver_1.default.Solve;
    const solution = solveFn.call(javascript_lp_solver_1.default, model);
